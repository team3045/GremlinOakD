...
public class GremlinTrigger implements BooleanSupplier {
   ...
   * @param condition the condition represented by this trigger
   */
  public GremlinTrigger(BooleanSupplier condition) {
   ...
   */
  public GremlinTrigger onTrue(Command command) {
   ...
   * @return this trigger, so calls can be chained
   */
  public GremlinTrigger onFalse(Command command) {
   ...
   * @return this trigger, so calls can be chained
   */
  public GremlinTrigger whileTrue(Command command) {
   ...
   * @return this trigger, so calls can be chained
   */
  public GremlinTrigger whileFalse(Command command) {
   ...
   * @return this trigger, so calls can be chained
   */
  public GremlinTrigger toggleOnTrue(Command command) {
   ...
   * @return this trigger, so calls can be chained
   */
  public GremlinTrigger toggleOnFalse(Command command) {
   ...
   */
  public GremlinTrigger and(BooleanSupplier trigger) {
    return new GremlinTrigger(() -> m_condition.getAsBoolean() && trigger.getAsBoolean());
  }
   ...
   */
  public GremlinTrigger or(BooleanSupplier trigger) {
    return new GremlinTrigger(() -> m_condition.getAsBoolean() || trigger.getAsBoolean());
  }
   ...
   */
  public GremlinTrigger negate() {
    return new GremlinTrigger(() -> !m_condition.getAsBoolean());
  }
   ...
   */
  public GremlinTrigger debounce(double seconds) {
